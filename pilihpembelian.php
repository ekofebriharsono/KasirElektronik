    ...
    <div class="container-fluid">
      ...
      <div class="card mb-3">
        <div class="card-header">
          <i class="fa fa-table"></i> Pilih Barang</div>
        <div class="card-body">
          <div class="card-body">
                      ...
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td><?php echo $row['nama_kategori']; ?>
                            <input hidden="hidden" type="text" name="nama_kategori" value="<?php echo $row['nama_kategori']; ?>">
                          </td>
                          <td><?php echo $row['nama_barang']; ?>
                            <input hidden="hidden" type="text" name="nama_barang" value="<?php echo $row['nama_barang']; ?>">
                          </td>
                          <td><?php echo $row['tipe']; ?>
                            <input hidden="hidden" type="text" name="tipe" value="<?php echo $row['tipe']; ?>">
                          </td>
                          <td>Rp. <?php echo $row['harga_jual']; ?> ,-
                            <input hidden="hidden" type="text" name="harga_jual" value="<?php echo $row['harga_jual']; ?>">
                          </td>
                          <td><input type="number" name="jumlah"></td>
                          <td><input class="btn btn-warning" type="submit" name="tambahpem"></td>

                          <!-- <td><a class="btn btn-danger" href="Tpenjualan.php?tambah=<?php //echo $row['nama_kategori']; ?>
                            &nama=<?php //echo $row['nama_barang'] ?>
                             &tipe=<?php //echo $row['tipe'] ?>
